...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(lms, api) {
        ...
        this.unsubZeroLeaves = this.api.emitMyZero.subscribe(function (r) {
            _this.hide = false;
        });
