...
var LmsService = /** @class */ (function () {
    function LmsService(api, router, snackBar) {
        this.api = api;
        this.router = router;
        this.snackBar = snackBar;
        this.loader = false;
    ...
    LmsService.prototype.snackBars = function (message, action) {
        this.snackBar.open(message, action, {
            duration: 2800,
        });
    };
    ...
    LmsService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__api_service__["a" /* ApiService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_3__angular_material__["y" /* MatSnackBar */]])
    ], LmsService);
    return LmsService;
}());
